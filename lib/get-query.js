...
export const getAllFields = ({ tableInternalName, tableInternalId, fields, children, level }) => [ 
...
export const getConditions = ({ tableInternalName, tableInternalId, conditions, conditionString, parentForeignKeyId, parentTable, parentId, level }) => wrapWhereClause(
  [ 
